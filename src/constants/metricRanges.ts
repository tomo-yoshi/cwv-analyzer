...
export const metricRanges: MetricRange = {
  ...
  'largest-contentful-paint': {
    ranges: ['0~2500', '2501~4000', '4001~6000', '6001~10000', '10001~'],
    unit: 'ms'
  },
  'cumulative-layout-shift': {
    ranges: ['0~0.1', '0.11~0.25', '0.26~0.5', '0.51~1', '1.01~'],
    unit: ''
  },
  'total-blocking-time': {
    ranges: ['0~200', '201~600', '601~1000', '1001~3000', '3001~'],
    unit: 'ms'
  },
  
  // Performance Metrics
  'speed-index': {
    ranges: ['0~3000', '3001~5000', '5001~7000', '7001~9000', '9001~'],
    unit: 'ms'
  },
  'interactive': {
